...
export const themes = {
  ...
  light: {
    ...
    input: "bg-[#e2e5e9] border-slate-300 focus:border-blue-500/60 text-slate-900 placeholder-slate-400",
    inputSell: "bg-[#e2e5e9] border-slate-300 focus:border-blue-500/60 text-slate-900 placeholder-slate-400",
    tabActive: "bg-blue-600 text-white",
