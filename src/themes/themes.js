...
export const themes = {
  ...
  light: {
    ...
    input: "bg-white border-slate-300 focus:border-blue-500/60 text-slate-800 placeholder-slate-400",
    inputSell: "bg-white border-slate-300 focus:border-blue-500/60 text-slate-800 placeholder-slate-400",
    tabActive: "bg-blue-600 text-white",
    tabInactive: "bg-white text-slate-600 hover:bg-slate-100 border border-slate-200",
    accent: "text-blue-600",
    accentBg: "bg-blue-600 hover:bg-blue-500",
    subtext: "text-slate-500",
    soldCard: "bg-slate-100 border-slate-200",
    sidebarItem: "bg-slate-100 hover:bg-slate-200 border-slate-200",
